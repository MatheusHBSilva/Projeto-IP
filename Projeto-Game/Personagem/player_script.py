...
class player:
    ...
    def __init__(self):
        ...
        self.y = 720 #y inicial da personaem
        ...
        self.player_collider = pygame.Rect(self.x, self.y, 30, 45)

        global vida
        global p_collidor 
        vida = self.vida
        p_collidor = self.player_collider
    ...
    def movimento(self):
        ...
        if(keys[pygame.K_SPACE] and self.double_jump_available and self.fall and self.double_jump_reset): #verifica o double jump // o double jump só é liberado caso a altura máxima aconteça ou caso o personagem está dando sliding, mas é possível mudar essa variável tranquilamente
